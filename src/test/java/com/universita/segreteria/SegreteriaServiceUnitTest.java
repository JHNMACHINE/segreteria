...
class SegreteriaServiceUnitTest {
    ...
    void testConfermaVoto_scenarioCorretto() {
        ...
        segreteriaService.confermaVoto(voto.getId());
    ...
    void testConfermaVoto_matricolaMancante() {
        ...
        assertThrows(RuntimeException.class, () -> segreteriaService.confermaVoto(1L));
    }
    ...
    void testConfermaVoto_votoNonAppartieneAStudente() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class, () -> segreteriaService.confermaVoto(1L));
